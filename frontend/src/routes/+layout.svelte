<script lang="ts">
  ...
  // Redirect logic. Both directions carry `?next=` so a link to somewhere
  // specific — a contact sent to a colleague, say — survives the sign-in round
  // trip instead of dumping the visitor on /contacts having never seen it.
