<script lang="ts">
  ...
  // Where sign-in lands. Honours ?next= so a shared link survives the round
  // trip — including the MFA step, which stays on this same URL, and the Google
  // popup flow, which never navigates away. Falls back to /contacts.
